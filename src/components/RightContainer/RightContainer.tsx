...
const RightContainer = () => {
  return (
    <div className="xl:w-1/4 w-full xl:min-h-screen xl:h-[1130px] h-fit  bg-[#FCFCFC] border border-[#E7E7E7] py-10 px-6 flex flex-col">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between border-b border-[#E7E7E7] py-3">
          <IconText
